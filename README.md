...
- technology-specific and difficult to generalize.
...
- **Training strategy**:
  ...
  - Fragmentation of long reads (up to 1024 tokens)

The model jointly learns **dependencies between sequencing errors and base quality**, producing more realistic synthetic reads than purely statistical methods.
...
- **SAM/BAM** – aligned reads used for transformer training
...
## Usage (Rule-Based Generator)

Generate PacBio reads:
```bash
python main.py reference.fasta 20x technology=PacBio output.fastq
